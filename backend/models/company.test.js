...
describe("get", function () {
  test("works", async function () {
    ...
    expect(company).toEqual({
      ...
      logoUrl: "http://c1.img",
      coins: [
        { id: testCoinIds[0], title: "Coin1", salary: 100, equity: "0.1" },
        { id: testCoinIds[1], title: "Coin2", salary: 200, equity: "0.2" },
        { id: testCoinIds[2], title: "Coin3", salary: 300, equity: "0" },
        { id: testCoinIds[3], title: "Coin4", salary: null, equity: null },
      ],
    });
  });
